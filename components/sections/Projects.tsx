      ...
      <div className="relative flex h-full items-center justify-center">
        ...
        >
          ...
          {nodes.map((node) => (
            ...
            >
              <span
                className={`h-1.5 w-1.5 rounded-full ${node.className}`}
              />
            </motion.span>
          ))}
        </motion.div>
...
<div className="relative flex flex-1 flex-col px-1 pb-1 pt-4">
  <div>
    ...
    <p className="mt-2 max-w-3xl text-[13px] leading-6 text-zinc-400 sm:text-sm">
      Implementación de cartillas digitales para Producción, Calidad y
      Operaciones, con validaciones funcionales, soporte a usuarios y
      despliegue en dispositivos PDA.
    </p>
  </div>
